...
*   **LinkedIn**: [qurban-ali](https://www.linkedin.com/in/qurbanali-pro/)
...
*   **AI & RAG Solutions**: LLM APIs (OpenAI, Gemini, DeepSeek), Vector Embeddings, Semantic Search, RAG Pipelines, Prompt Engineering, Vector Databases
*   **Backend Development**: PHP, Laravel, Node.js, Express.js, Python, FastAPI, Flask, REST APIs
*   **Frontend Development**: React.js, Vue.js, Quasar Framework, TypeScript, JavaScript (ES6+), HTML5, CSS3
*   **Databases & Search**: MySQL, PostgreSQL, Supabase, Apache Solr
*   **DevOps & Systems**: Linux, Nginx, Apache, Jenkins CI/CD, Git, GitHub
...
*   Led end-to-end delivery of multiple web applications using Laravel, Vue.js, and RESTful APIs from requirements gathering to production deployment.
*   Managed sprint ceremonies including planning, retrospectives, and daily standups for a team of 4+ developers.
*   Developed IShopEco — an eco-friendly e-commerce platform using Quasar Framework (Vue.js) and a Laravel backend.
*   Built GerDentUSA and GerVetUSA B2B e-commerce platforms featuring surgical instruments catalog management and order workflows.
*   Implemented database query optimization, caching strategies, and server-side rendering to improve performance and scalability.
*   Conducted technical interviews, onboarded new team members, and enforced coding standards.

### 3. Junior Laravel Developer | PHP (Laravel), React JS
**GerMedUSAIT** | *January 2019 — July 2020*
*   Developed and maintained Laravel-based web applications, building RESTful APIs, Eloquent ORM models, and Blade frontend interfaces.
*   Contributed to GerDentUSA and GerVetUSA e-commerce platforms, including catalog search and order processing modules.
*   Collaborated on database schema design, migrations, and MySQL query optimization.
*   Gained hands-on experience with Git version control, Linux server management, and Nginx/Apache web server configurations.
...
## 🎓 Education
*   **Bachelor of Arts** (2019) | University of the Punjab
*   **Intermediate / A-Level** — CS, Mathematical Statistics, Mathematics (2016) | Government College of Sciences, Lahore
*   **Matriculation / O-Level** — Biology, Chemistry, Physics (2014) | Government High School
